<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagePreferences.aspx.cs" Inherits="uforme.ManagePreferences" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center">MANAGE PREFERENCES</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
